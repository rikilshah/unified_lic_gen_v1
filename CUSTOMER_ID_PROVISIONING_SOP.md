...
- Automated tests cover hardware detection by serial prefix, hardware-specific default-flash serial validation, complete private/public key package export, header staging, ID generation, persistence/recovery, hardware mismatch rejection, profile artifacts, and header compatibility.
